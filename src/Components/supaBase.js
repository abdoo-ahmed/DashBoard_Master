...
export async function addUser(name, email, phone, age,access) {
  try {
    const res = await fetch(`${SUPABASE_URL}/rest/v1/User`, {
      ...
      body: JSON.stringify({ name, email, phone,access, age })
    });
...
export async function getUserByEmail(email) {
  ...
  try {
    const res = await fetch(`${SUPABASE_URL}/rest/v1/User?email=eq.${encodeURIComponent(email)}&limit=1`, {
      method: "GET",
      headers: {
        apikey: SUPABASE_KEY,
        Authorization: `Bearer ${SUPABASE_KEY}`,
...
export async function getUserById(userId) {
  try {
    const res = await fetch(
      `${SUPABASE_URL}/rest/v1/User?id=eq.${userId}`,
      {
        method: "GET",
        headers: {
          apikey: SUPABASE_KEY,
...
// console.log(await addUser("sief", "sief011146]ds@gmail.com", "01011771146",22,"admin") ); 

// console.log(await updateUser({id:"1",email:"mazen0101177dsmsdmskdm1146@gmail.com", gender:"mazenkdfjdk", age: 245}) ); 
// console.log(await updateUser({id:"1",name:"mazen0101177dsmsdmskdm1146@gmail.com",  age: 25545}) ); 
// console.log(await deleteUser("1") ); 
// console.log(await getUserById("1") ); 
// console.log(await searchUserByName("maz") ); 

// console.log( await getUserByEmail("mazen01011771146@gmal.com"));
